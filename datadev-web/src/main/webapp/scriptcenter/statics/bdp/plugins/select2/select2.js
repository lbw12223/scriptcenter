...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initSelection: function () {
            var selected;
            if (false && this.isPlaceholderOptionSelected()) {
        ...
        isPlaceholderOptionSelected: function() {
            ...
            return ((placeholderOption = this.getPlaceholderOption()) !== undefined && placeholderOption.is(':selected')) ||
                   (this.opts.element.val() === undefined) || (this.opts.element.val() === "") ||
        ...
        updateSelection: function (data) {
            ...
            if (typeof formatted != "undefined" && formatted != undefined && formatted != "undefined" && formatted.indexOf("undefined") < 0) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        addSelectedChoice: function (data) {
            ...
            if(data == null || data.length == 0) {
                var next = $('.select2-highlighted').next();
            ...
            if(flag) {//todo;;;;
                $(choice).find('div').css("color","red").html($(data).html());
            }
        },
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "没有匹配结果"; },
