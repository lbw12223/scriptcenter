...
define("ace/autocomplete/popup", ["require", "exports", "module", "ace/virtual_renderer", "ace/editor", "ace/range", "ace/lib/event", "ace/lib/lang", "ace/lib/dom"], function (require, exports, module) {
    ...
    var $singleLineEditor = function (el) {
        var renderer = new Renderer(el, undefined, 0, 25);
    ...
    var AcePopup = function (parentNode) {
        ...
        bgTokenizer.$tokenizeRow = function (row) {
            ...
            if(data.sqlType){
                tokens.push({type: "sql-type", value: " "+data.sqlType});
            }
            if (data.meta) {
         ...
         * 计算宽度
         */
        popup.caculateWidth = function () {
            var maxSize = 0;
            for (var index = 0; index < popup.data.length; index++) {
                var temp = popup.data[index];
                var size = temp.meta.length + temp.value.length + (temp.sqlType ? temp.sqlType.length : 0);
                if (size > maxSize) {
                    maxSize = size;
                }
            }
            return maxSize * 10 < 280 ? 280 : maxSize * 10;
        ...
        popup.show = function (pos, lineHeight, topdownOnly) {
            ...
            el.style.display = "";
            el.style.width = popup.caculateWidth() + "px";
            this.renderer.$textLayer.checkForSizeChanges();

            var left = pos.left;
            if (left + el.offsetWidth > screenWidth){
                left = screenWidth - el.offsetWidth - 32;
            }
    ...
    (function () {
        this.setFilter = function (str) {
            ...
            matches = matches.sort(function (a, b) {
                return a.matchMask - b.matchMask || b.exactMatch - a.exactMatch || b.score - a.score;
            });
            var prev = null;
