$(function () {
    ...
    function toShareTemplate(templateId) {
        saveTemplate && saveTemplate(null, templateId, function (template) {
            ...
            var container = $(".template-container[data-id='" + templateId + "']");
            $(".template-name span", container).attr("data-title", name).text(name);
            $(".template-desc span", container).attr("data-title", desc).text(desc);
        });
    }
